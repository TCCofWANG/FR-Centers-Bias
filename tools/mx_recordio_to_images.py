...
def main(args):
    ...
    for name in val_targets:
        shutil.copy(
            os.path.join(args.root_dir, "{}.bin".format(name)),
            os.path.join(args.output_dir, "{}.bin".format(name)))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--root_dir", type=str, help="Root directory to mxnet dataset.", )
