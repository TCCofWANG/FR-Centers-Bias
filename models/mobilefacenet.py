...
class MobileFaceNet(Module):
    def __init__(self, num_features=512, blocks=(1, 4, 6, 2), scale=2, fp16=False):
...
def get_mbf(num_features=512, fp16=False, blocks=(1, 4, 6, 2), scale=2):
    return MobileFaceNet(num_features, blocks, scale=scale, fp16=fp16)


def get_mbf_large(num_features=512, fp16=False, blocks=(2, 8, 12, 4), scale=4):
    return MobileFaceNet(num_features, blocks, scale=scale, fp16=fp16)
